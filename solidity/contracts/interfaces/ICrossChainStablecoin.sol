...
interface ICrossChainStablecoin is IERC721 {
  ...
  event LiquidateVault(
    uint256 vaultID, address owner, address buyer, uint256 debtRepaid, uint256 collateralLiquidated, uint256 closingFee
  );
  ...
  function isValidCollateral(uint256 _collateral, uint256 debt) external view returns (bool);
